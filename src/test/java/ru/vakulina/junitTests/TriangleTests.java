package ru.vakulina.junitTests;
...
import ru.vakulina.junit.SquareTriangle;
...
public class TriangleTests {
    ...
    public void testHp() {
        ...
        double act_result = SquareTriangle.hp(A, B, C);
    ...
    public void testSquare() {
        ...
        double act_result = SquareTriangle.square(A, B, C);
        double exp_result = 6;
    ...
    void paramSquareTest(double a, double b, double c) {
        log.info("\t\t\tSTART THIS TEST");
